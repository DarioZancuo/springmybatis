...
<div style="display: flex; justify-content: center; align-items: center; margin-top: 20px;">
    <s:form modelAttribute="contratto" action="${pageContext.request.contextPath}/contratto/createProcess" method="post">
        ...
        <input type="hidden" name="idEmployee" value="${idEmployee}" />
            ...
            <tr>
                <td colspan="2" style="text-align: center;">
                    <button type="submit" style="width: 100%; padding: 5px;">Save Contratto</button>
                </td>
            </tr>
