...
<body>
    <div style="display: flex; justify-content: center; margin-top: 20px;">
        <form action="${pageContext.request.contextPath}/category/updateProcess" method="post">
                ...
                <tr>
                    <td colspan="2">
                        <button type="submit" style="width: 100%; padding: 5px;">
                            <c:choose>
                                <c:when test="${category.code == 'hobbies'}">Update Hobby</c:when>
                                <c:when test="${category.code == 'country'}">Update Country</c:when>
